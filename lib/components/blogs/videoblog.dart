     ...
     return   Scaffold(
      ...
      NestedScrollView(
        ...
        flexibleSpace: FlexibleSpaceBar(
          title: Text("what's new in\nandroid 12?",style: Styles.headlinestyle.copyWith(color: Colors.white,fontWeight: FontWeight.bold)),
          background:  Stack(
            children:[ Positioned(
                            top: -30,
                            right: -40,
       ...
       body: Container(
        ...
        padding: const EdgeInsets.symmetric(horizontal: 9,vertical: 9),
         child: Column(
          ...
          _videocontroller.value.isInitialized ? AspectRatio(aspectRatio: 
                        ...
                        children: [
                              ...
                              children: [
                                ...
                                Divider(
                                 ...
                                 SizedBox(height: 5,),
                                Text("- Colourful UI Design & Wallpaper-Based Material You Theme.\n",style: Styles.smallheadlinestyle.copyWith(color: Colors.white,fontSize: 18),),
                                Text("- Extra Large Clock Widget On The Lockscreen.\n",style: Styles.smallheadlinestyle.copyWith(color: Colors.white,fontSize: 18),),
                                Text("- New Quick Setting Tiles Design & New Tiles For Smart Home Controls, Digital Wallet, Internet, And Privacy Controls.\n",style: Styles.smallheadlinestyle.copyWith(color: Colors.white,fontSize: 18),),
                                
                                Text("- Privacy Dashboard & Security Improvements\n",style: Styles.smallheadlinestyle.copyWith(color: Colors.white,fontSize: 18),),
                                Text("- Camera & Microphone Access Indicators\n",style: Styles.smallheadlinestyle.copyWith(color: Colors.white,fontSize: 18),),
                                Text("- One-Handed Mode\n",style: Styles.smallheadlinestyle.copyWith(color:Colors.white,fontSize: 18),),
                                Text("- Haptic Feedback With Audio\n",style: Styles.smallheadlinestyle.copyWith(color: Colors.white,fontSize: 18),),
                                Text("- Google Discover Material You Theme\n",style: Styles.smallheadlinestyle.copyWith(color: Colors.white,fontSize: 18),),
