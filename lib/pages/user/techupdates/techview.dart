                ...
                sliver: SliverAppBar(
                  ...
                  flexibleSpace: FlexibleSpaceBar(
                    title: Text("compepetitve coding\nJava or c++?",
                        style: Styles.headlinestyle.copyWith(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 20 )), 
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                "Summary",
                                style: Styles.smallheadlinestyle.copyWith(color: Colors.white,fontSize: 18,fontWeight: FontWeight.bold)  ),
                              Text(
                                "Posted on : 25/02/23",
